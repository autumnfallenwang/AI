...
from common.utils import DetectionDataset
...
def get_dataset(dataset, args):
    if dataset.lower() == 'voc':
        ...
        train_dataset = DetectionDataset(image_root, train_label_file, classes, 
                                         map_file=map_file)
        val_dataset = DetectionDataset(image_root, val_label_file, classes, 
                                       map_file=map_file, 
                                       shuffle=False)
